...
//inclass
var allslides = document.querySelector('.carousel');
function mouseupOnImage(evt)
{
    var target = evt.target;
...
allslides.addEventListener('mousemove',mouseupOnImage);
...
allslides.addEventListener('mouseout',mouseDownOnImage);
...
// document.querySelector('.carousel').addEventListener('mouseup', function(evt) 
// {
//     var target = evt.target;
